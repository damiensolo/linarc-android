...
- Captured photos must land on Today, as Plan pins, and in the Images grid — never only in a private list. The full-screen photo viewer is a pager over the whole Images set (swipe between photos like the plan sheet viewer; per-page zoom) — do not regress it to a single-photo screen (2026-09-04).

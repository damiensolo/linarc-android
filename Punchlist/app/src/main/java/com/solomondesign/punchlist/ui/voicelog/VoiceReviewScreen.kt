    ...
    Scaffold(
        ...
        bottomBar = {
            Column(modifier = Modifier.padding(16.dp)) {
                PunchlistButton(text = "Submit", onClick = onSubmit, type = PunchlistButtonType.Primary)
            }
        },
    ) { padding ->
        Column(
...
private fun CardSection(
    ...
    Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp)) {
        ...
        Card(
            colors = CardDefaults.cardColors(containerColor = DesignTokens.MutedSurface),
...
fun VoiceLogSubmittedScreen(onDone: () -> Unit, modifier: Modifier = Modifier) {
    Column(
        ...
        PunchlistButton(text = "Done", onClick = onDone)
    }
}

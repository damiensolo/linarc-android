...
import com.solomondesign.punchlist.ui.voicelog.audio.AndroidSpeechTranscriber
import com.solomondesign.punchlist.ui.voicelog.audio.DictationController
import com.solomondesign.punchlist.ui.voicelog.audio.MediaRecorderAudioRecorder
        ...
        bottomBar = {
            Row(
                ...
                PunchlistButton(
                    ...
                    type = PunchlistButtonType.Primary,
                    modifier = Modifier.weight(1f),
                )
            }
        },
...
private fun MicPermissionRequiredScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Spacer(Modifier.height(24.dp))
            PunchlistButton(text = "Allow Microphone Access", onClick = onRetry)
        }
    }
}

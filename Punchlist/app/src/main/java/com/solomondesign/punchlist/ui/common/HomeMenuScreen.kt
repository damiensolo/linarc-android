package com.solomondesign.punchlist.ui.common
 ...
 * [PunchlistButton] design-system component. Used for every tab's home screen and
    ...
    Column(
        ...
        if (ctas.isNotEmpty()) {
            Column(
                ...
                ctas.forEach { cta ->
                    PunchlistButton(text = cta.label, onClick = cta.onClick, type = cta.type)
                }
            }
        }
    }
